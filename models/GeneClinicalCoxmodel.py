# -*- coding: utf-8 -*-
"""
Created on Sun Dec  8 11:47:10 2022
...
class G_XVAE(keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            total_loss = (reconstruction_loss + self.gamma * self.kld_weight * K.abs(kl_loss - C)) * self.k_vl + (cox_loss + cox_regularisation_loss) * self.k_cl
