# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 16:41:27 2021
...
class H_VAE_Cox_model():
    ...
    def build_model(self, hp):
        ...
        c = layers.Dense(n2_unit , activation="tanh",kernel_initializer=initializers.GlorotUniform(seed=None), kernel_regularizer=l2(l2_regularizer))(c)
...
class VAE(keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            rna, clinical, y_event, y_time = data[0]
            ...
            total_loss = reconstruction_loss * self.k_vl + (self.gamma * self.kld_weight* K.abs(kl_loss - C) + cox_loss + regularisation_loss) * self.k_cl
