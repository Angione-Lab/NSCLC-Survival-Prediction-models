# -*- coding: utf-8 -*-
"""
Created on Mon Jan  3 15:30:25 2022
...
def nested_cross_validate_model(feature_df,clinical_features,y_event,y_time, n_folds=5):
    ...
    for train_test_ix, validation_idx  in k_outer_fold.split(feature_df):
        ...
        tuner.search(x = [train_rad, train_clic, train_event, train_time],
        ...
        history = best_model.fit(x = [train_test_rad, train_test_clic, train_test_event, train_test_time], 
                     batch_size=batch_size, 
                     epochs=epochs,
...
val_c_index, best_hyperparameters, pred_risk_list, time, event = nested_cross_validate_model(feature_dataset,clinical_features,y_event,y_survival_time, n_folds=5)
print(val_c_index)
