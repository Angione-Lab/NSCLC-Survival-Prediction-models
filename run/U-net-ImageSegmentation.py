# -*- coding: utf-8 -*-
"""
Created on Fri Nov  5 19:22:06 2021
...
def train_model(slices, segment_slices, n_folds=5):
    ...
    for train_ix, test_ix  in k_inner_fold.split(slices):
        ...
        history = segment_model.fit(train_slices,train_segment_slices, validation_data=(test_slices,test_segment_slices), batch_size=10, epochs=50, shuffle=True)
        i = i+1
