...
#pathway <- read.csv(file = 'C:\\1.workingDirectory\\NSCLCSruvivalPrediction\\Results\\Biological_interpretation\\H_vae_kegg_pathway_barplot_list.csv')

#KEGG Pathway for X-VAE-Cox model
pathway <- read.csv(file = 'C:\\1.workingDirectory\\NSCLCSruvivalPrediction\\Results\\Biological_interpretation\\X-VAE_cox model_kegg_barplot_list.csv')
